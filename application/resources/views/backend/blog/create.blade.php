...
<div class="container-fluid">
    <div class="row">
        <form class="card" action="{{route('backend.blog.store')}}" method="POST" enctype="multipart/form-data"
            id="blogAdd">
            @csrf
            <div class="col-sm-12 col-md-12 col-xl-12">
                <div class="card-header pb-0">
                    <h4 class="card-title mb-0">Add Blog
                        ...
                        <div class="col-md-8">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-2">
                                    ...
                                    <input class="form-control" type="text" id="comment" name="meta_comment"
                                        placeholder="Comment">
                                </div>
