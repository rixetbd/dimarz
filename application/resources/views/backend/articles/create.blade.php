...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <form class="card" action="{{route('backend.articles.store')}}" method="POST" enctype="multipart/form-data" id="productAdd">
                @csrf
                <div class="card-header pb-0">
                    <h4 class="card-title mb-0">Add Article
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="mb-3">
                                <label class="form-label" for="title">Comments (Optional)</label>
                                <input class="form-control" type="text" id="comments" name="comments" placeholder="Comments">
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div>
