        ...
        <div class="col-sm-12 col-md-12">
            <div class="card">
                <div class="card-header pb-0">
                    ...
                    <h5>FAQ List <span class="float-end"><button class="btn btn-primary" id="add_faq"> <i
                                    class="fa fa-plus"></i> Add FAQ</button></span></h5>

                    <span>All FAQ Information</span>
                </div>
