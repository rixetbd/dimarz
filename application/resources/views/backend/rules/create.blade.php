...
@section('page_title', 'Add Rule Page')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-xl-12">
            <form class="card" action="{{route('backend.rules.store')}}" method="POST" enctype="multipart/form-data" id="articlesAdd">
                @csrf
                <div class="card-header pb-0">
                    <h4 class="card-title mb-0">Add Rule Page
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                                ...
                                <input class="form-control" type="text" id="rules_name" name="rules_name" placeholder="Rules Name">
                        </div>
                        <div class="col-md-12 mb-3">
                                <label class="form-label required" for="description">Description</label>
                                <textarea class="form-control" placeholder="Enter Message" id="description" name="description"></textarea>
                        </div>
                    </div>
                </div>
                <div class="card-footer text-end">
                    <button type="submit" class="btn btn-primary">Add Rule Page</button>
                </div>
            </form>
        </div>
    </div>
