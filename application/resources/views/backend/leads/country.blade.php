    ...
    <div class="row">
        <div class="col-sm-12 col-md-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('backend.country.store')}}" class="dataStore">
                        @csrf
                        <div class="mb-3">
                        ...
                        <div class="my-3">
                            <input type="text" class="form-control" name="phonecode" placeholder="Phone Code"
                                required="">
                        </div>
                        <div class="my-3">
...
<script>
    $('#dataTableStyle').DataTable({
        ajax: {
            url: `{{route('backend.country.autocountry')}}`,
            dataSrc: ''
        },
        columns: [{
                data: null,
    ...
    function cat_distroy(id) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                $.ajax({
                    type: "POST",
                    url: `{{route('backend.country.destroy')}}`,
                    data: {
                        "id": id
                    },
                    success: function (data) {
