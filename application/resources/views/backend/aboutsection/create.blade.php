...
@section('page_title', 'New About Section')
...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="col-sm-12 col-md-12 col-xl-12">
            <form class="card" action="{{route('backend.aboutsection.store')}}" method="POST" enctype="multipart/form-data" id="articlesAdd">
                @csrf
                <div class="card-header pb-0">
                    <h4 class="card-title mb-0">Add About Section
                        <span class="float-end">
                            <a class="btn btn-primary" href="{{route('backend.articles.index')}}">Check About Section List</a>
                        </span>
                    </h4>
