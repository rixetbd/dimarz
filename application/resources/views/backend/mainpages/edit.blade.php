                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="mb-3">
                                ...
                                <select class="form-select" id="extra_section" name="extra_section">
                                    ...
                                    <option value="lead" {{($mainpage->extra_section == "lead"?'selected':'')}}>Lead Generation Section</option>
                                    <option value="graphic" {{($mainpage->extra_section == "graphic"?'selected':'')}}>Graphic Section</option>
                                </select>
                            </div>
                        </div>
